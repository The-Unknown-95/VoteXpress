...
# Add this line to make window resizable
...
while True:
    ...
    scale_percent = 70  # Adjust this value to control window size (70% of original)
    ...
    # Rest of your voting logic remains unchanged...
    # [Keep all the vote handling code below exactly as in your original version]
